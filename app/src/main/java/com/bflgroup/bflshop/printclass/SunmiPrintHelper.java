package com.bflgroup.bflshop.printclass;
...
public class SunmiPrintHelper {
    ...
    public void printText(String content, float size, boolean isBold, boolean isUnderLine,
        ...
        try {
            try {
                ...
                if (isBold) {
                    sunmiPrinterService.sendRAWData(com.bflgroup.bflshop.printclass.ESCUtil.boldOn(), null);
                } else {
                    sunmiPrinterService.sendRAWData(com.bflgroup.bflshop.printclass.ESCUtil.boldOff(), null);
                }
            }
            try {
                ...
                if (isUnderLine) {
                    sunmiPrinterService.sendRAWData(com.bflgroup.bflshop.printclass.ESCUtil.underlineWithOneDotWidthOn(), null);
                } else {
                    sunmiPrinterService.sendRAWData(com.bflgroup.bflshop.printclass.ESCUtil.underlineOff(), null);
                }
            }
    ...
    public void printExample(Context context){
        ...
        try {
            ...
            Bitmap bitmap = BitmapFactory.decodeResource(context.getResources(), R.mipmap.bfllogo);
            sunmiPrinterService.printBitmap(bitmap, null);
