...
public class GrnDirectDeliveryDbManager {
    private SQLiteDatabase sqlDB;
    static final String dBName="DIDEL";
    static final String tableName="GrnDirectDeliveryItems";
    ...
    public GrnDirectDeliveryDbManager(Context context){
        GrnDirectDeliveryDbManager.DatabaseHelperUser db=new GrnDirectDeliveryDbManager.DatabaseHelperUser(context);
