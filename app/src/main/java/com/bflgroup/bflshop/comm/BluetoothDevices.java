...
public class BluetoothDevices {
    ...
    private static String[] deviceArray = new String[30];
    ...
    public boolean loadBluetoothDevicesArray() {
        ...
        objGlobal.setBluetoothDevicesYellow(arr);
        objGlobal.setBluetoothDevicesRed(arr);
        objGlobal.setBluetoothDevicesWhite(arr);
        return true;
    }
